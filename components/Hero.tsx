        ...
        <div className="grid items-center gap-8 md:gap-12 md:grid-cols-2">
          ...
          <div className="flex justify-center md:justify-start order-1 md:order-1">
            <div className="relative h-[280px] w-[280px] md:h-[380px] md:w-[380px] animate-fade-in-up">
              ...
              {/* DOCX badge */}
              <div className="absolute -left-6 top-1/3 flex h-12 w-20 -translate-y-1/2 items-center justify-center rounded-2xl bg-white text-[10px] font-semibold text-slate-600 shadow-lg shadow-slate-200/80 border border-gray-100 animate-float-slow">
                <span className="mr-1 rounded-md bg-slate-900 px-1.5 py-1 text-[9px] font-bold text-white">DOCX</span>
              </div>

              {/* File text icon */}
              <div className="absolute -right-3 top-[8%] flex h-13 w-13 items-center justify-center rounded-2xl bg-white shadow-md shadow-slate-200/80 border border-gray-100 animate-float-reverse">
              ...
              {/* Spreadsheet icon */}
              <div className="absolute right-6 bottom-[10%] flex h-13 w-13 items-center justify-center rounded-2xl bg-white shadow-md shadow-slate-200/80 border border-gray-100 animate-float">
              ...
              {/* Star icon */}
              <div className="absolute left-6 bottom-[8%] flex h-13 w-13 items-center justify-center rounded-2xl bg-white shadow-md shadow-slate-200/80 border border-gray-100 animate-float-slow">
              ...
              {/* Sparkles icon */}
              <div className="absolute left-1/2 top-[6%] flex h-10 w-10 -translate-x-1/2 items-center justify-center rounded-2xl bg-white shadow-md shadow-slate-200/80 border border-gray-100 animate-float-reverse">
