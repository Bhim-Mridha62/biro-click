          ...
          <div className="relative flex justify-center md:justify-start">
            ...
            <div className="grid max-w-2xl grid-cols-1 gap-8 sm:grid-cols-2">
              {tools.map((tool, i) => (
                <div
                  key={i}
                  className={`relative mx-auto w-full max-w-sm bg-white p-8 text-right shadow-[0_22px_65px_rgba(15,23,42,0.08)] ring-1 ring-slate-100/90 backdrop-blur-sm animate-fade-in-up ${tool.offsetClass || ""}`}
                  style={{
                ...
                >
                  ...
                  <button className="mt-4 flex items-center gap-1 text-xs font-bold text-pink-500 transition-all hover:gap-2" dir="rtl">
                    התחילו עכשיו
